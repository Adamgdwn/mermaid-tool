...
- fit oversized diagrams into the preview or fullscreen presentation view with one click
...
- Current targets:
  - `release/Mermaid Tool-0.1.6-x86_64.AppImage`
  - `release/Mermaid Tool-0.1.6-amd64.deb`
