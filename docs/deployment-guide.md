...
7. Install with either:
   ...
   - `sudo dpkg -i "release/Mermaid Tool-0.1.5-amd64.deb"` for a system package
   - `chmod +x "release/Mermaid Tool-0.1.5-x86_64.AppImage"` and launch the AppImage directly
